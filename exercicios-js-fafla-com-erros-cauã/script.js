...
const btns = [
  ...
  },
  {
    ...
    func: () => {
      let pares = 0;
      for (let i = 1; i <= 10; i++) {
        let num = parseInt(prompt(`Digite o número ${i}º:`));
        if (num % 2 === 0) pares++;
      }
  ...
  },
  {
    ...
    func: () => {
      ...
      while (true) {
        let numero = parseFloat(prompt("Digite um número positivo (ou negativo para parar)"));
      ...
      if(quant > 0){
        ...
        alert(`A média dos ${quant} número(s) positivos é : ${media.toFixed(2)}`)
      }else{
  ...
  },
  {
    ...
    func: () => {
      ...
      const busca = parseInt(prompt("Digite um número para buscar:"));
  ...
  },
  {
    ...
    func: () => {
      ...
      const n = Number(prompt("Digite um número de 0 a 7:"));
  ...
  },
  {
    ...
    func: () => {
      let soma = 0;
      for (let i = 1; i <= 5; i++) soma += Number(prompt(`Idade ${i + 1}:`));
